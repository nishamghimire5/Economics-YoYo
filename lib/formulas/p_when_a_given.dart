...
class PWhenAGiven extends StatefulWidget {
  const PWhenAGiven({super.key});

  @override
  State<PWhenAGiven> createState() => _PWhenAGivenState();
}
...
class _PWhenAGivenState extends State<PWhenAGiven> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Finding P when A is given"),
      ),
      body: Form(
        key: _formKey,
