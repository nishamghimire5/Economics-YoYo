...
class AWhenFGiven extends StatefulWidget {
  const AWhenFGiven({super.key});

  @override
  State<AWhenFGiven> createState() => _AWhenFGivenState();
}
...
class _AWhenFGivenState extends State<AWhenFGiven> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Finding A when F is given"),
  ...
  String _calculateTotalReturns() {
    ...
    double annuityAmount = future * (roi / (pow(1 + roi, term) - 1));
    // double totalInterest = annuityAmount - future;
    ...
    String result = '''
        ...
        Annuity Amount = 
        = $sign $future x [ $roi / {(1 + $roi)^$term - 1} ]
